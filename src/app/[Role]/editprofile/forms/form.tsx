...
export default function form() {
  ...
  return (
    <div className='flex flex-col mx-40 mb-10   h-full'>
        <form action=""
        ref={FormRef}
        ...
        //   }
        // }}
        className='container flex pb-5 border-2 rounded-lg  flex-col  border-solid mb-10  bg-white border-gray-200  h-full'>
            ...
            <Input className='mb-5 bg-slate-100  focus-visible:ring-offset-0 focus-visible:ring-[#2752B8]'   type='number' placeholder='## ### ###'/>

            <label className='mb-5 ' > About me</label>
            <Textarea name="AboutMe" className='mb-5 bg-slate-100 focus-visible:ring-offset-0 focus-visible:ring-[#2752B8]' />

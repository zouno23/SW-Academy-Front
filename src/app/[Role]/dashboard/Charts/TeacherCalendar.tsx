...
export default function TeacherCalendar(events : any) {
    return ( 
        <div className='  w-1/2  max-md:w-full max-md:h-min  h-full bg-white rounded-2xl p-2 shrink-0 dark:bg-slate-900 min-h-[420px] '>

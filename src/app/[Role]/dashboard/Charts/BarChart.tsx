...
function BarChart({ Data }: any) {
  ...
  return (
    <div
      className={cn(
        "min-w-1/2 max-w-2/3 bg-white flex flex-col rounded-2xl p-4 flex-shrink max-md:w-full flex-grow-0 justify-between dark:bg-slate-900 w-2/3",
        userData?.Role === "Teacher" && "w-1/2"
      )}
    >

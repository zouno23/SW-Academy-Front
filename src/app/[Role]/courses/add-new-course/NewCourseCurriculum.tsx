...
function Curriculum({lessons,setLessons}:{lessons : LessonsType , setLessons : Dispatch<SetStateAction <LessonsType>>}) {
        return (
        <>
    ...
    {lessons ?<LessonsList lessons={lessons} setLessons={setLessons}/>:null}

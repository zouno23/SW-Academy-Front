...
import woman1 from "@/../public/Resources/womanlog2.png"
...
function LoginCard() {
    ...
    <main className="h-3/4 w-3/5 bg-white/25 rounded-2xl border-[2px] border-white/50 flex flex-row">
        <div className="w-1/2 overflow-visible justify-between flex flex-col pb-10 m-3 shrink-0">
            <p className="text-white font-bold text-2xl w-7/12 ">
        ...
        <Image src={woman1} alt="woman holding a tablet" width={450} height={900} className="-ml-36"/>
    </main> );
}

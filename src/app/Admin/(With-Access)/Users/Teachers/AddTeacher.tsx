"use client";
import { AddTeacher } from "@/app/Actions/Admin/AdminUsersActions";
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill the teacher details. Click save when you're done.
          </DialogDescription>
        </DialogHeader>
        <form
          ...
          action={async (FormData) => {
            ...
            const ApiResponse = await AddTeacher({ FullName, Email, Password });
